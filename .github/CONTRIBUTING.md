...
[here](https://github.com/samuelbernardolip/gophercloud/tree/master/docs/contributor-tutorial)!
...
[bug tracker](https://github.com/samuelbernardolip/gophercloud/issues) and finding open
...
and can be read online at [godoc.org](https://godoc.org/github.com/samuelbernardolip/gophercloud).
...
get dependencies for unit and acceptance tests.
   ...
   ```bash
   go get -tags "fixtures acceptance" github.com/samuelbernardolip/gophercloud
   ```

2. Move into the directory that houses your local repository:

   ```bash
   cd ${GOPATH}/src/github.com/samuelbernardolip/gophercloud
   ```
...
7. Submit your branch as a [Pull Request](https://help.github.com/articles/creating-a-pull-request/). When submitting a Pull Request, please follow our [Style Guide](https://github.com/samuelbernardolip/gophercloud/blob/master/docs/STYLEGUIDE.md).
