...
import (
	...
	"github.com/samuelbernardolip/gophercloud/openstack/blockstorage/noauth"
)
...
func AcceptanceTestChoicesFromEnv() (*AcceptanceTestChoices, error) {
	...
	/* // Temporarily disabled, see https://github.com/samuelbernardolip/gophercloud/issues/1345
	if networkID == "" {
