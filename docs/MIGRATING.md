...
* `github.com/samuelbernardolip/gophercloud/openstack/compute/v2/extensions/floatingip` is now `github.com/samuelbernardolip/gophercloud/openstack/compute/v2/extensions/floatingips`
